...
Requires: blockdiag-python3
Requires: blockdiag-license
...
export LANG=C
export SOURCE_DATE_EPOCH=1536550710
...
%install
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/blockdiag
cp LICENSE %{buildroot}/usr/share/doc/blockdiag/LICENSE
cp src/blockdiag/tests/VLGothic/LICENSE %{buildroot}/usr/share/doc/blockdiag/src_blockdiag_tests_VLGothic_LICENSE
cp src/blockdiag/tests/VLGothic/LICENSE.en %{buildroot}/usr/share/doc/blockdiag/src_blockdiag_tests_VLGothic_LICENSE.en
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/blockdiag/LICENSE
/usr/share/doc/blockdiag/src_blockdiag_tests_VLGothic_LICENSE
/usr/share/doc/blockdiag/src_blockdiag_tests_VLGothic_LICENSE.en
